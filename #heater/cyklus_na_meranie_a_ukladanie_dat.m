...
% target_values = [33, 66, 100]; %meA
% target_values = [25, 50, 75, 100];
% target_values = [50, 100];
% target_values = [100];    %meA
% % MOZNOST B (ZANICA OD 100)
% target_values = [66, 33, 0]; %me
...
settled_window = 30; % Number of consecutive values within threshold for settling
%settled_window = 5;
settled_count = 0;
wait_iterations = 80; % Number of iterations to wait after each increase
%wait_iterations = 5;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% point 
%vesna.upload('heater', 0); % MOZNOST A
vesna.upload('heater', 100); % MOZNOST B
