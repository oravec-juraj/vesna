  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section">
      <li id="cid_1" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-large">
          <div class="header-text httal htvam">
            <h1 id="header_1" class="form-header" data-component="header">Advanced Greenhouse Control</h1>
          </div>
        </div>
      </li>
      <li id="cid_31" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-small">
          <div class="header-text httac htvam">
            <h3 id="header_31" class="form-header" data-component="header">Discrete controller settings</h3>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_number" id="id_11">
        <label class="form-label form-label-top" id="label_11" for="sampling"> Sampling time </label>
        <div id="cid_11" class="form-input-wide" data-layout="half"> 
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="sampling" id="sublabel_input_11" style="min-height:13px" aria-hidden="false">Time in seconds</label>
          </span> 
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_number" id="id_13">
        <label class="form-label form-label-top" id="label_13" for="z_r"> Controller proportional constant </label>
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_number" id="id_14">
        <label class="form-label form-label-top" id="label_14" for="t_i"> Controller integration constant </label>
      ...
      <li class="form-line form-line-column form-col-4" data-type="control_number" id="id_27">
        <label class="form-label form-label-top" id="label_27" for="t_d"> Controller derivative constant </label>
      ...
      <li id="cid_34" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-small">
          <div class="header-text httac htvam">
            <h3 id="header_34" class="form-header" data-component="header">Ventilation settings</h3>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-4" data-type="control_number" id="id_29">
        <label class="form-label form-label-top" id="label_29" for="vent_duration"> Duration of ventilation </label>
        <div id="cid_29" class="form-input-wide" data-layout="half"> 
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="vent_duration" id="sublabel_input_29" style="min-height:13px" aria-hidden="false">Time in seconds</label>
          </span> 
        </div>
      </li>
      <li class="form-line form-line-column form-col-5" data-type="control_number" id="id_30">
        <label class="form-label form-label-top" id="label_30" for="vent_start"> Ventilation period </label>
        <div id="cid_30" class="form-input-wide" data-layout="half"> 
          <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <label class="form-sub-label" for="vent_start" id="sublabel_input_30" style="min-height:13px" aria-hidden="false">Time in seconds</label>
          </span> 
        </div>
      </li>
      <li class="form-line" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide" data-layout="full">
          <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField"><button id="input_2" type="submit" class="form-submit-button form-submit-button-simple_green_apple submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">Submit</button></div>
        </div>
      </li>
