...
@section('content')
<form class="jotform-form" action="/control/environment/stored" method="post" name="form_223546564962364" id="223546564962364" accept-charset="utf-8" autocomplete="off"><input type="hidden" name="formID" value="223546564962364" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" />
@csrf 
  <div role="main" class="form-all">    
    ...
    <ul class="form-section page-section">
      <li id="cid_1" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-large">
          <div class="header-text httal htvam">
            <h1 id="header_1" class="form-header" data-component="header">Greenhouse Environment Control</h1>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_radio" id="id_24">
        <label class="form-label form-label-top form-label-auto" id="label_24" for="input_24"> Control of humidification <i class="fa-solid fa-droplet"></i></label>
        <div id="cid_24" class="form-input-wide" data-layout="full">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_24" data-component="radio">
            <span class="form-radio-item">
              ...
              <label id="label_input_24_0" for="pump_on">Turn ON humidification</label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item"></span>
              ...
              <label id="label_input_24_1" for="pump_off">Turn OFF humidification</label>
            </span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_radio" id="id_31"><label class="form-label form-label-top form-label-auto" id="label_31" for="input_31"> Control of lighting <i class="fa-regular fa-sun"></i></label>
        <div id="cid_31" class="form-input-wide" data-layout="full">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_31" data-component="radio">
            <span class="form-radio-item">
              ...
              <label id="label_input_31_0" for="lighting_on">Turn ON lighting</label>
            </span>
            <span class="form-radio-item"><span class="dragger-item"></span>
              ...
              <label id="label_input_31_1" for="lighting_off">Turn OFF lighting</label>
            </span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_radio" id="id_32">
        <label class="form-label form-label-top form-label-auto" id="label_32" for="input_32"> Control of ventilation <i class="fa-solid fa-wind"></i></label>
        <div id="cid_32" class="form-input-wide" data-layout="full">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_32" data-component="radio">
            <span class="form-radio-item">
              ...
              <label id="label_input_32_0" for="fans_on">Turn ON the fan</label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item"></span>
              <input type="radio" aria-describedby="label_32" class="form-radio" id="fans_off" name="fans" {{$fans_show_off}} value="Turn off the fan" />
              <label id="label_input_32_1" for="fans_off">Turn OFF the fan</label>
            </span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_radio" id="id_30">
        <label class="form-label form-label-top form-label-auto" id="label_30" for="input_30"> Control of irrigation <i class="fa-solid fa-faucet-drip"></i></label>
        <div id="cid_30" class="form-input-wide" data-layout="full">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_30" data-component="radio">
            ...
            <label id="label_input_30_0" for="irrigator_on">Turn ON irrigation</label>
          </span>
          <span class="form-radio-item">
            <span class="dragger-item"></span>
              ...
              <label id="label_input_30_1" for="irrigator_off">Turn OFF irrigation</label>
            </span>
          </div>
        </div>
      </li>
